...
author:
  - .tiny.b[__Yen-Chieh Liao & Li Tang (University of Birmingham)__]  
  - .tiny.b[Presented at the Taiwan Soochow University Legislative Studies Workshop]  
# date: ".tiny.b[Jun 8 2026]"
output:
...
--
  ...
  - When ${\color{#fb6107} \kappa_i^p = \color{#fb6107}0}$: &nbsp; $\mu_i^{p,\text{post}} = \mu_i^{p,\text{pre}}$ &nbsp;→ signal gets ignored canvasser completely

--

  - When ${\color{#44C1C4} \kappa_i^p = \color{#44C1C4}1}$: &nbsp; $\mu_i^{p,\text{post}} = s_i^p$ &nbsp;→ fully believe canvasser
...
.pull-right[
- **Prop. 1** Own-party contact **reduces** misperception
...
.pull-right[
- **Prop. 1** Own-party contact **reduces** misperception
- **Prop. 2** Rival-party contact has **no effect** ($t_L \approx 0$)
<!-- - **P3** Own-party contact **increases** perceived polarisation -->
<!--   + (corrects centrist bias → widens perceived gap) -->
<!-- - **P4** Effects larger for **weak partisans** -->
<!--   + (noisier priors → more room to correct) -->
...
.pull-right[
- **Prop. 3** Own-party contact **increases** perceived polarisation
  + (corrects centrist bias → widens perceived gap)
<!-- - **P4** Effects larger for **weak partisans** -->
<!--   + (noisier priors → more room to correct) -->
...
- **Prop. 3** Own-party contact **increases** perceived polarisation
  + (corrects centrist bias → widens perceived gap)
- **Prop. 4** Effects larger for **weak partisans**
  + (noisier priors → more room to correct)
...
> Conservative supporters ignore Labour canvassers.  
> Labour supporters ignore Conservative canvassers.
...
- This aligns with Proposition 3
...
---
layout: true
# .tiny[To Wrap-up: The Unintended Consequence]
---

.center[.hi-slate[Campaign knocks on your door]]
...
.center[.hi-slate[Own-party perception moves outward] &nbsp; .grey-mid[(rival unchanged)]]

--

.center[.grey-mid[↓]]

.center[.hi[**You perceive a WIDER ideological gap**]]

--

.center[.grey-mid[↓]]

.center[.note[Not through distortion — through .it[selective correction]]]

--

&nbsp;

.center[.smaller[The same mechanism that makes voters .hi-turquoise[better-informed] also makes them perceive .hi[greater polarisation]]]
...
- The polarisation effect stems from **informational asymmetry**, not manipulation
- If brief canvassing produces effects this detectable, the same logic applies
  to partisan social media at far greater scale

--

.hi-grey[**Future work:**]

field experiment to establish causal identification
